<div>
    ...
    <div
        ...
        <div
            ...
            <x-primary-button href="{{ url('admin/people/supervisors/create') }}">
                ...
                @forelse ($items as $item)
                    <tr wire:key='{{ $item->id }}'
                        ...
                        <th scope="row"
                            ...
                            @if (!$item->image)
                                <a href="{{ asset('assets/images/supervisors/image.png') }}" class="glightbox">
                                    <img src="{{ asset('assets/images/supervisors/image.png') }}"
                                        alt="iMac Front Image" class="object-cover h-10 mr-3 aspect-[1/1]">
                                </a>
                            @else
                                <a href="{{ asset('assets/images/supervisors/' . $item->image) }}" class="glightbox">
                                    <img src="{{ asset('assets/images/supervisors/' . $item->image) }}"
                                        alt="iMac Front Image" class="object-cover h-10 mr-3 aspect-[1/1]">
                                </a>
                            @endif
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-start justify-center gap-3">
                                ...
                                <div class="pb-1" x-data="{ tooltip: false }">
                                    <!-- Modal toggle -->
                                    <a href="{{ url('admin/people/supervisors/'.$item->id.'/edit') }}" @mouseenter="tooltip = true" @mouseleave="tooltip = false">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
