<div>
    ...
    <form class="w-full" action="{{ route('admin.items.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid lg:grid-cols-2 lg:gap-6">
            ...
            <div class="relative w-full mb-5 group">
                <x-input-label for="audio_category_id" :value="__('Category')" />
                <div class="flex flex-1 gap-1 mt-1">
                    <div class="flex justify-start flex-1">
                        <x-select-option wire:model.live='audio_category_id' id="audio_category_id"
                            name="audio_category_id" class="category-select">
                ...
                <x-input-error :messages="$errors->get('audio_category_id')" class="mt-2" />
            </div>
            {{-- End Category Select --}}

            {{-- Start Sub-Category Select --}}
            <div class="relative w-full mb-5 group">
                <x-input-label for="audio_sub_category_id" :value="__('Sub-Category')" />
                <div class="flex flex-1 gap-1 mt-1">
                    <div class="flex justify-start flex-1">
                        <x-select-option wire:model.live='audio_sub_category_id'
                            id="audio_sub_category_id" name="category_id" class="sub-category-select">
                            <option wire:key='sub-category' value="">
                                {{ $audio_category_id ? 'Select Sub-Category...' : 'Select Category First' }}
                            </option>
                ...
                <x-input-error :messages="$errors->get('audio_sub_category_id')" class="mt-2" />
            </div>
        ...
        <div class="grid lg:grid-cols-2 lg:gap-6">
            ...
            <div class="relative w-full mb-5 group">
                ...
                <div class="flex flex-1 gap-1 mt-1">
                    <div class="flex justify-start flex-1">
                        <x-select-option wire:model.live='audio_type_id' id="types"
                            name="audio_type_id" class="type-select">
                    ...
                    <button type="button" data-modal-target="audio_type_modal"
                        data-modal-toggle="audio_type_modal"
                        class="rounded-md text-sm p-2.5 font-medium text-center text-white bg-blue-700 ">
                        Add
                    </button>

                    <!-- Start Type modal -->
                    <div id="audio_type_modal" tabindex="-1" aria-hidden="true"
                        class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full lg:inset-0 h-[calc(100%-1rem)] max-h-full">
                        <div class="relative w-full max-w-md max-h-full p-4">
                            <!-- Modal content -->
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="p-4 lg:p-5">
                                    ...
                                    <div class="text-right">
                                        <button data-modal-target="audio_type_modal"
                                            data-modal-toggle="audio_type_modal" type="button"
                ...
                <x-input-error :messages="$errors->get('audio_type_id')" class="mt-2" />
            </div>
            {{-- Start Type Select --}}
        ...
        <div class="mb-5">
            ...
            <div class="flex items-center space-4" wire:key='uploadfile'>
                <div class="flex flex-col flex-1">
                    <label class='mb-4 text-sm font-medium text-gray-600 dark:text-white'>
                        Upload Audio File (Max : 50MB) <span class="text-red-500">*</span>
                    </label>
                    <div class="relative flex items-center justify-center w-full -mt-3 overflow-hidden">
                        <label for="file"
                            class="flex flex-col items-center justify-center w-full h-40 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                ...
                                <p class="mb-2 text-sm text-gray-500 dark:text-gray-400"><span
                                        class="font-semibold">Click to upload</span> or drag and drop</p>
                                <p class="mb-2 text-xs text-gray-500 dark:text-gray-400">mp3 (MAX. 50MB)</p>
                                @if ($file)
                            ...
                            accept="audio/mp3" class="absolute h-[140%] w-[100%]" />
                        </label>
                    </div>
