<div>
    ...
    <div
        ...
        <div
            ...
            <!-- Start Role modal -->
            <div id="Role_modal" tabindex="-1" aria-hidden="true"
                            ...
                            <div class="grid grid-cols-2 gap-4 mb-4 ">
                                <div class="col-span-2">
                                    ...
                                    <input wire:key="{{ rand() }}" type="text" name="name"
                                        id="name" wire:model='newRoleName'
                    ...
                    <tr wire:key='{{ $item->id }}'
                        ...
                        <td class="px-6 py-4 ">
                            <div class="flex items-start justify-center gap-3">
                                @if ($editId == $item->id)
                                    <button wire:click='cancelUpdateRole()'
                                        class="flex items-center justify-center w-full px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg md:w-auto focus:outline-none hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
                                        type="button">
                                        Cancel
                                    </button>
                                    <button wire:confirm='Are you sure? You want to update {{ $item->name }}'
                                        wire:click='updateRole({{ $item->id }})'
