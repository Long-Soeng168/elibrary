                    ...
                    <tr wire:key='{{ $item->id }}'
                        ...
                        <th scope="row"
                            ...
                            <a href="{{ asset('assets/images/news/' . $item->image) }}" class="glightbox">
                                <img src="{{ asset('assets/images/news/thumb/' . $item->image) }}"
                        ...
                        <x-table-data value="{{ $item->newsCategory?->name }}" />
                        {{-- <x-table-data value="{{ $item->newssubCategory?->name }}" /> --}}
                        <x-table-data value="{{ $item->newsType?->name }}" />
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-start justify-center gap-3">
                                <div class="pb-1" x-data="{ tooltip: false }">
                                    <!-- Modal toggle -->
                                    <a href="{{ url('admin/bulletins_images/'.$item->id) }}" @mouseenter="tooltip = true" @mouseleave="tooltip = false"
                                        class="relative">
                                ...
                                <div class="pb-1" x-data="{ tooltip: false }">
                                    <!-- Modal toggle -->
                                    <a href="{{ url('admin/bulletins/'.$item->id . '/edit') }}"  @mouseenter="tooltip = true" @mouseleave="tooltip = false">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
