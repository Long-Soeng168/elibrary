<div>
    ...
    <div
        ...
        <div
            ...
            <x-primary-button data-modal-target="Permission_modal" data-modal-toggle="Permission_modal">
            ...
            <div id="Permission_modal" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div
                            ...
                            <button type="button"
                                ...
                                data-modal-toggle="Permission_modal">
                        ...
                        <div class="p-4 lg:p-5">
                            <div class="grid grid-cols-2 gap-4 mb-4 ">
                                <div class="col-span-2">
                                    ...
                                    <input wire:key="{{ rand() }}" type="text" name="name" autofocus
                                        id="name" wire:model='newPermissionName'
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        placeholder="Name">
                                </div>
                            </div>
                            <div class="text-right">
                                <button data-modal-target="Permission_modal" data-modal-toggle="Permission_modal"
                                    type="button" wire:click='saveNewPermission' wire:target="saveNewPermission"
                    ...
                    <tr wire:key='{{ $item->id }}'
                        ...
                        <td class="px-6 py-4 ">
                            <div class="flex items-start justify-center gap-3">
                                @if ($editId == $item->id)
                                    <button wire:click='cancelUpdatePermission()'
                                        class="flex items-center justify-center w-full px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg md:w-auto focus:outline-none hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
                                        type="button">
                                        Cancel
                                    </button>
                                    <button wire:confirm='Are you sure? You want to update {{ $item->name }}'
                                        wire:click='updatePermission({{ $item->id }})'
                                ...
                                @else
                                    ...
                                    <div class="pb-1" x-data="{ tooltip: false }">
                                        <!-- Modal toggle -->
                                        <a data-modal-target="edit_Permission_modal" data-modal-toggle="edit_Permission_modal"
