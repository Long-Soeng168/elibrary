                ...
                @forelse ($items as $item)
                    <tr wire:key='{{ $item->id }}'
                        ...
                        <th scope="row"
                            ...
                            <a href="{{ asset('assets/images/images/' . $item->image) }}" class="glightbox">
                                <img src="{{ asset('assets/images/images/thumb/' . $item->image) }}"
                        ...
                        <x-table-data value="{{ $item->imageCategory?->name }}" />
                        {{-- <x-table-data value="{{ $item->imagesubCategory?->name }}" /> --}}
                        <x-table-data value="{{ $item->imageType?->name }}" />
