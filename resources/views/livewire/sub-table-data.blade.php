                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="p-4 lg:p-5">
                            <div class="grid grid-cols-2 gap-4 mb-4 ">
                                ...
                                <div class="col-span-2">
                                    <label for="category"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Main Menu</label>
                                        ...
                                        <option wire:key="selectCate" {{ !$new_category_id ? 'selected' : '' }} value="">Select Main Menu</option>
                            ...
                            <div class="text-right">
                                <button data-modal-target="create_modal" data-modal-toggle="create_modal"
                                    type="button" wire:click='save' wire:target="save"
                        ...
                        @else
                            ...
                            <x-table-data>
                                <span
                                    ...
                                    {{ $item->protected_area?->name ? $item->protected_area?->name : 'N/A' }}
                                </span>
                            </x-table-data>
                        @endif
