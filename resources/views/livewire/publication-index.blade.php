            ...
            <div class="max-w-screen-xl mx-auto">
                <form class="w-full " action="search_book.html">
                    <div class="flex flex-wrap gap-2">
                        ...
                        <!-- Dropdown menu -->
                        <div id="multi-dropdown" class="z-30 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-[250px] dark:bg-gray-700" wire:ignore>
                        ...
                        <div class="flex flex-1">
                            <input type="search" id="search-dropdown" wire:model.live.debounce.300ms='search'
                                class="block p-2.5 w-full z-20 text-md text-gray-900 bg-gray-50 border-gray-50 border-1 border  focus:ring-primary focus:border-blue-500 dark:bg-gray-700 dark:border-gray-300 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500 rounded-bl-lg md:rounded-bl-none  border-primary"
                                placeholder="Search..." />
                            <button type="submit"
        ...
        <div class="max-w-screen-xl grid-cols-12 gap-4 px-2 mx-auto lg:grid xl:px-0">
            ...
            <div wire:ignore id="accordion-collapse" data-accordion="collapse" class="col-span-2 mt-6">
                <h2 id="accordion-collapse-heading-2">
                    <button type="button"
                        class="flex items-center justify-between w-full gap-2 px-2 py-1 mb-4 bg-gray-200 dark:bg-gray-500"
                ...
                <div class="max-w-screen-xl mx-auto mt-6">
                    ...
                    @if ($selected_categories_item || $selected_sub_categories_item)
                        <div class="relative flex flex-wrap gap-2 p-2 pt-4 mt-4 border rounded-md shadow-md">
                            ...
                            {{-- Filter top title --}}
                            <div
                                class="absolute px-2 duration-300 bg-white border-l border-r dark:bg-gray-800 dark:text-white -top-3 left-2">
                            ...
                            <a wire:key="{{ $item->id }}-{{ $index }}" class="block group" href="{{ url('publications/'.$item->id) }}">
                                ...
                                <div class="relative pt-2" x-data="{ tooltipVisible: false }">
                                    ...
                                    <div x-show="tooltipVisible" x-transition
                                        class="absolute z-10 px-3 py-2 text-sm font-medium text-white bg-gray-600 rounded-lg shadow-sm dark:bg-gray-700"
                                        style="display: none;">
                                        {{ $item->name }}
