<div>
                                ...
                                @else
                                    <li class="hover:underline" wire:key="{{ $category->id }}">
                                        <div class="flex">
                                            ...
                                            <button id="doubleDropdownButton-{{ $category->id }}"
                                                data-dropdown-toggle="doubleDropdown-{{ $category->id }}"
                                        ...
                                        <div id="doubleDropdown-{{ $category->id }}"
                                            ...
                                            <div
                                                class="py-1 font-bold text-center underline bg-gray-200 border-b border-b-primary dark:border-b-white dark:bg-gray-600">
                                                @if (app()->getLocale() == 'kh' && $category->name_kh)
                                                    {{ $category->name_kh }}
                                                @else
                                                    {{ $category->name }}
                                            ...
                                            <ul class="text-sm text-gray-700 dark:text-gray-100"
                                                ...
                                                @forelse ($category->subCategories as $subCategory)
                                                    <li class="hover:underline" wire:key="{{ $subCategory->id }}">
                                                        <div class="flex items-center flex-1 gap-2 pl-2 hover:bg-gray-200 dark:hover:bg-gray-600 dark:hover:text-white"
                                                            wire:change="handleSelectSubCategory({{ $subCategory->id }})">
                                                            <input type="checkbox"
                                                                id="subCategory-{{ $subCategory->id }}"
                                                                name="selected_sub_categories[]"
                                                                value="{{ $subCategory->id }}">
                                                            <label class="flex-1 py-2 pr-2"
    ...
    <div class="max-w-screen-xl grid-cols-12 px-2 mx-auto lg:grid xl:px-0">
        ...
        <div wire:ignore id="accordion-collapse" data-accordion="collapse" class="col-span-1 mt-6">
            ...
            <div id="accordion-collapse-body-2" class="hidden lg:block"
                        ...
                        <div class="grid items-center grid-cols-3 gap-4 sm:grid-cols-3 lg:grid-cols-1">
                            @forelse ($menu_databases as $index => $database)
                                @if ($database->type == 'slug')
                                    <a class="{{ $database->slug == 'publications' ? 'bg-gray-200 dark:bg-gray-700' : '' }} flex flex-col items-center justify-center p-2 group hover:bg-gray-100 rounded-xl dark:hover:bg-gray-600 "
