                    ...
                    <tr wire:key='{{ $item->id }}'
                        ...
                        <th scope="row"
                            ...
                            <a href="{{ asset('assets/images/theses/' . $item->image) }}" class="glightbox">
                                <img src="{{ asset('assets/images/theses/thumb/' . $item->image) }}"
                            ...
                            <div class="flex items-start justify-center gap-3">
                                @can('update thesis')
                                    <div class="pb-1" x-data="{ tooltip: false }">
                                        <!-- Modal toggle -->
                                        <a href="{{ url('admin/theses_images/' . $item->id) }}"
                                ...
                                @can('view thesis')
                                    <div class="pb-1" x-data="{ tooltip: false }">
                                        <!-- Modal toggle -->
                                        <a href="{{ url('theses/' . $item->id) }}" @mouseenter="tooltip = true"
                                ...
                                @can('update thesis')
                                    <div class="pb-1" x-data="{ tooltip: false }">
                                        <!-- Modal toggle -->
                                        <a href="{{ url('admin/theses/' . $item->id . '/edit') }}"
