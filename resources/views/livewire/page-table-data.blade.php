<div>
    ...
    <div
        ...
        <div
            ...
            @can('create general')
            <x-primary-button href="{{ url('admin/general/page/create') }}">
        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <th scope="col" class="px-4 py-3">Main Menu</th>
                    <th scope="col" class="px-4 py-3">Sub Menu</th>
                    ...
                    <th scope="col" class="py-3">Image Link</th>
                    <th scope="col" class="py-3">Video Link</th>
                    ...
                    <tr wire:key='{{ $item->id }}'
                        ...
                        <x-table-data>
                            <span
                                ...
                                {{ $item->protected_area ? $item->protected_area->name : '' }}
                            </span>
                        </x-table-data>
                        <x-table-data>
                            <span
                                class="bg-primary-50 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300 whitespace-nowrap">
                                {{ $item->area ? $item->area->name : '' }}
                            </span>
                        </x-table-data>
                        <x-table-data value="{{ $item->name }}" />
                            <x-table-data value="{{ $item->video_url }}" />
                            <x-table-data value="{{ $item->image_url }}" />
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-start justify-center gap-3">
                                ...
                                <div class="pb-1" x-data="{ tooltip: false }">
                                    <!-- Modal toggle -->
                                    <a href="{{ url('admin/general/page/'.$item->id.'/edit') }}" @mouseenter="tooltip = true" @mouseleave="tooltip = false">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
