<div>
    ...
    <form class="w-full" action="{{ route('admin.items.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid lg:grid-cols-2 lg:gap-6">
            ...
            <div class="relative w-full mb-5 group">
                <x-input-label for="news_category_id" :value="__('Category')" />
                <div class="flex flex-1 gap-1 mt-1">
                    <div class="flex justify-start flex-1">
                        <x-select-option wire:model.live='news_category_id' id="news_category_id"
                            name="news_category_id" class="category-select">
            ...
            <div class="relative w-full mb-5 group">
                <x-input-label for="news_sub_category_id" :value="__('Sub-Category')" />
                <div class="flex flex-1 gap-1 mt-1">
                    <div class="flex justify-start flex-1">
                        <x-select-option wire:model.live='news_sub_category_id'
                            id="news_sub_category_id" name="category_id" class="sub-category-select">
                            <option wire:key='sub-category' value="">
                                {{ $news_category_id ? 'Select Sub-Category...' : 'Select Category First' }}
                            </option>
                ...
                <x-input-error :messages="$errors->get('news_sub_category_id')" class="mt-2" />
            </div>
        ...
        <div class="grid lg:grid-cols-2 lg:gap-6">
            ...
            <div class="relative w-full mb-5 group">
                ...
                <div class="flex flex-1 gap-1 mt-1">
                    <div class="flex justify-start flex-1">
                        <x-select-option wire:model.live='news_type_id' id="types"
                    ...
                    <button type="button" data-modal-target="news_type_modal"
                        data-modal-toggle="news_type_modal"
                        class="rounded-md text-sm p-2.5 font-medium text-center text-white bg-blue-700 ">
                        Add
                    </button>

                    <!-- Start Type modal -->
                    <div id="news_type_modal" tabindex="-1" aria-hidden="true"
                        class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full lg:inset-0 h-[calc(100%-1rem)] max-h-full">
                        <div class="relative w-full max-w-md max-h-full p-4">
                            <!-- Modal content -->
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="p-4 lg:p-5">
                                    ...
                                    <div class="text-right">
                                        <button data-modal-target="news_type_modal"
                                            data-modal-toggle="news_type_modal" type="button"
                ...
                <x-input-error :messages="$errors->get('news_type_id')" class="mt-2" />
            </div>
            {{-- Start Type Select --}}
