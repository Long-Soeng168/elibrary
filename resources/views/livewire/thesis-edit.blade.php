                ...
                <div class="flex flex-1 gap-1 mt-1">
                    <div class="flex justify-start flex-1">
                        <x-select-option wire:model='major_id' id="majors"
                            ...
                            <option wire:key='major' value="0">Select Major...</option>
                            @forelse ($majors as $major)
                                <option wire:key='{{ $major->id }}' value="{{ $major->id }}">
                                    {{ $major->name }}</option>
                            @empty
                                <option wire:key='nomajor' value="0">--No major--</option>
                            @endforelse
                        </x-select-option>
                    </div>
                ...
                <div class="flex flex-1 gap-1 mt-1">
                    <div class="flex justify-start flex-1">
                        <x-select-option class="student-select" wire:model.live='student_id' id="student"
                            ...
                            @empty
                                <option wire:key='nostudent' value="0"> --No Student--</option>
                            @endforelse
                        </x-select-option>
                    </div>
                ...
                <div class="flex flex-1 gap-1 mt-1">
                    <div class="flex justify-start flex-1">
                        <x-select-option class="lecturer-select" wire:model.live='lecturer_id' id="lecturer"
                            name="lecturer_id">
                            <option wire:key='lecturer' value="0">Select Lecturer...</option>
                            @forelse ($lecturers as $lecturer)
                                <option wire:key='{{ $lecturer->id }}' value="{{ $lecturer->id }}">
                                    {{ $lecturer->name }}
                                </option>
                            @empty
                                <option wire:key='nolecturer' value="0"> --No Lecturer--</option>
                            @endforelse
                        </x-select-option>
                    </div>
                ...
                <div class="flex flex-1 gap-1 mt-1">
                    <div class="flex justify-start flex-1">
                        <x-select-option class="supervisor-select" wire:model.live='supervisor_id' id="supervisor"
                            name="supervisor_id">
                            <option wire:key='supervisor' value="0">Select Supervisor...</option>
                            @forelse ($supervisors as $supervisor)
                                <option wire:key='{{ $supervisor->id }}' value="{{ $supervisor->id }}">
                                    {{ $supervisor->name }}
                                </option>
                            @empty
                                <option wire:key='nosupervisor' value="0"> --No Supervisor--</option>
                            @endforelse
                        </x-select-option>
                    </div>
