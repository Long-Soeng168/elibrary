            ...
            <div class="flex flex-col items-center col-span-2 px-2 mb-6 mr-2 lg-px-0">
                <div class="max-w-[100%] flex flex-col gap-2">
                    <a href="https://flowbite.s3.amazonaws.com/docs/gallery/square/image-10.jpg" class="glightbox">
                        <img class="max-w-[100%] h-auto object-cover rounded-md cursor-pointer"
                    ...
                    <div class="grid grid-cols-4 gap-2">
                        <a href="https://flowbite.s3.amazonaws.com/docs/gallery/square/image-9.jpg" class="glightbox">
                            <img class="w-full aspect-[1/1] hover:scale-105 transition-transform duration-500 ease-in-out object-cover rounded-md"
                        ...
                        <div
                            class="relative w-full aspect-[1/1] hover:scale-105 transition-transform duration-500 ease-in-out">
                            <button
