            ...
            <div class="flex flex-wrap gap-2">
                ...
                <div id="dropdown"
                    ...
                    <ul class="py-2 text-gray-700 text-md dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                        <li>
                            <a href="http://catalog.libraryrac.com/cgi-bin/koha/opac-search.pl" class="menu-catalog-link block px-6 py-2 hover:bg-gray-100 }} dark:hover:bg-gray-600 dark:hover:text-white">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            searchInput.addEventListener('input', function() {
                ...
                menuCatalog.forEach(function(item) {
                    const baseUrl = item.getAttribute('href').split('?')[0];
                    item.setAttribute('href', baseUrl + '?q=' + encodeURIComponent(query));
                });
