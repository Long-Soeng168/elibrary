...
use App\Models\ThesisImage as MultiImage;
use App\Models\Thesis;
use Livewire\WithFileUploads;
use Image;
use Illuminate\Support\Facades\File;

class ThesisImage extends Component
{
    use WithFileUploads;
    ...
    public function mount(Thesis $item)
    {
    ...
    public function save()
    {
        ...
        $filePath = public_path('assets/images/theses');
        $fileThumbPath = public_path('assets/images/theses/thumb');
    ...
    {
        $multiImages = MultiImage::where('thesis_id', $this->item->id)->latest()->get();
        return view('livewire.thesis-image', [
