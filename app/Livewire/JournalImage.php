...
use App\Models\JournalImage as MultiImage;
...
class JournalImage extends Component
{
    ...
    public function mount(Journal $item)
    {
    ...
    public function save()
    {
        ...
        $filePath = public_path('assets/images/journals');
        $fileThumbPath = public_path('assets/images/journals/thumb');
    ...
    {
        $multiImages = MultiImage::where('journal_id', $this->item->id)->latest()->get();
        return view('livewire.journal-image', [
