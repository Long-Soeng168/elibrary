...
use App\Models\VideoImage as MultiImage;
...
class VideoImage extends Component
{
    ...
    public function mount(Video $item)
    {
    ...
    public function save()
    {
        ...
        $filePath = public_path('assets/images/videos');
        $fileThumbPath = public_path('assets/images/videos/thumb');
    ...
    {
        $multiImages = MultiImage::where('video_id', $this->item->id)->latest()->get();
        return view('livewire.video-image', [
