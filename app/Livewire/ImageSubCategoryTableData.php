...
use App\Models\ImageSubCategory as SubCategory;
use App\Models\ImageCategory as Category;

class ImageSubCategoryTableData extends Component
{
    use WithPagination;
    ...
    public function delete($id)
    {
     ...
     public function save()
     {
         try {
             $validated = $this->validate([
                 'newName' => 'required|string|max:255|unique:image_sub_categories,name',
             ...
             SubCategory::create([
                 ...
                 'image_category_id' => $this->new_category_id,
             ]);
     ...
     public function setEdit($id) {
        ...
        $this->category_id = $subCategory->image_category_id;
     }
    ...
    public function render(){
        ...
        return view('livewire.image-sub-category-table-data', [
            'items' => $items,
