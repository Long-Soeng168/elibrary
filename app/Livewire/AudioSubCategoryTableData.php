...
class AudioSubCategoryTableData extends Component
{
    use WithPagination;
    ...
    public function delete($id)
    {
     ...
     public function save()
     {
         try {
             $validated = $this->validate([
                 'newName' => 'required|string|max:255|unique:audio_sub_categories,name',
     ...
     public function setEdit($id) {
        ...
        $this->category_id = $subCategory->audio_category_id;
     }
     ...
     public function update($id) {
        try {
            ...
            $subCategory->update([
                ...
                'audio_category_id' => $this->category_id
            ]);
    ...
    public function render(){
        ...
        return view('livewire.audio-sub-category-table-data', [
            'items' => $items,
