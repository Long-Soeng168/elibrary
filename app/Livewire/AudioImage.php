...
use App\Models\AudioImage as MultiImage;
use App\Models\Audio;
use Livewire\WithFileUploads;
use Image;
use Illuminate\Support\Facades\File;

class AudioImage extends Component
{
    use WithFileUploads;
    ...
    public function mount(Audio $item)
    {
    ...
    public function save()
    {
        ...
        $filePath = public_path('assets/images/audios');
        $fileThumbPath = public_path('assets/images/audios/thumb');
    ...
    {
        $multiImages = MultiImage::where('audio_id', $this->item->id)->latest()->get();
        return view('livewire.audio-image', [
