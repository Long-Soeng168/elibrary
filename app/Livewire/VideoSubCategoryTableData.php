...
use App\Models\VideoSubCategory as SubCategory;
use App\Models\VideoCategory as Category;

class VideoSubCategoryTableData extends Component
{
    use WithPagination;
    ...
    public function delete($id)
    {
     ...
     public function save()
     {
         try {
             $validated = $this->validate([
                 'newName' => 'required|string|max:255|unique:video_sub_categories,name',
             ...
             SubCategory::create([
                 ...
                 'video_category_id' => $this->new_category_id,
             ]);
     ...
     public function setEdit($id) {
        ...
        $this->category_id = $subCategory->video_category_id;
     }
     ...
     public function update($id) {
        try {
            ...
            $subCategory->update([
                ...
                'video_category_id' => $this->category_id
            ]);
    ...
    public function render(){
        ...
        return view('livewire.video-sub-category-table-data', [
            'items' => $items,
